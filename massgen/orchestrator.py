        ...
        if is_decomposition:
            ...
            injection_parts = [
                ...
                *lines,
                ...
                "   b) SELECTIVELY ADOPT - Keep YOUR solution as the primary base. Identify SPECIFIC",
                "      superior elements from their work (a component, design pattern, algorithm, or",
                "      visual approach) and integrate only those targeted improvements into YOUR",
                "      existing implementation. Do NOT replace your whole solution — borrow only",
                "      what is demonstrably better in that specific area.",
                "   c) REBUILD with synthesis - If their overall approach is fundamentally superior,",
                "      rebuild drawing on the best elements from both solutions.",
                "   d) BUILD on their work - Use their answer as the starting point and extend it",
                "      with your unique contributions and improvements.",
                "   e) CONTINUE your own approach if you believe it's better",
                "",
